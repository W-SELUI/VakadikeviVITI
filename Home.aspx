...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
        ...
        <section class="video-section">
            <h2>Experience Fiji</h2>
            <p>Watch and see why Fiji is the greatest destination in the South Pacific</p>
            <section class="video-wrapper">
                <iframe
                    src="https://www.youtube.com/embed/_R8srHqe_OI"
                    title="Fiji Tourism Video"
                    frameborder="0"
        ...
        <% If Session("UserLoggedIn") IsNot Nothing AndAlso Session("UserLoggedIn") = True Then %>
            <section class="download-section">
                <h2>Fiji Travel Guide</h2>
                <p>Download our free Fiji Travel Guide and plan your perfect trip!</p>
                <a href="https://assets.ctfassets.net/v228i5y5k0x4/6PUf4pEbLOkUqyQYoMGmsu/e8457aa8ec1a435640f212021401a6b9/Fiji.pdf" 
                    target="_blank" 
                    class="download-btn">
